...
export  const inputStyle = "form-control block w-full px-3 py-1.5 text-base dark:bg-mblack dark:focus:bg-zinc-900 bg-yellow-500 bg-clip-padding border border-solid border-gray-300 dark:border-zinc-900 rounded transition ease-in-out m-0 focus:bg-white focus:border-primary dark:focus:border-primary focus:outline-none mb-2"