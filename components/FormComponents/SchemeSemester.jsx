...
const SchemeSemester = (props) => {
    ...
    const boxControl = "basis-1/2 dark:bg-lblack bg-white  px-6 py-3 rounded-md m-2 flex items-start flex-col justify-between text-gray-700 dark:text-neutral-300 border dark:border-neutral-800"
    ...
    return (
        <div id="boxRow" className='flex flex-col md:flex-row'>
            <div className={boxControl}>
                <h1 className='font-bold text-sm my-2 text-green-600 dark:text-green-400'>REVISION SCHEME</h1>
            ...
            {type=='KT'?(
                <div className={boxControl}>
                <h1 className='font-bold text-sm text-primary dark:text-green-400'>KT SEMESTER DETAILS</h1>
                ...
                <div className={boxControl}>
                <h1 className='font-bold text-sm text-primary dark:text-green-400'>CURRENT SEMESTER DETAILS</h1>
                <div className='flex flex-col my-2 w-full'>
                    <select className={selectStyle}>
                        <option>Computer</option>
                        <option>Mechanical</option>
